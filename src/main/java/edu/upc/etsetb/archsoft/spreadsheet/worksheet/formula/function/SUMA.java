...
public class SUMA extends Function {
    ...
    /**
     * Function that returns a SUMA object. It assigns the correct token and the
     * function sequence
     *
    ...
    /**
     * Function that calculates the final value of the SUMA function introduced
     * by the user from a list of floats.
     *
     * @param list List of floats containing all the values to consider when
     * computing a SUMA function
     * @return float with the sum of all the floats contained in the introduced
     * list.
     */
    @Override
    ...
    /**
     * Function that returns an error when a SUMA function has been introduced
     * incorrectly.
     */
    @Override
    void getError() {
