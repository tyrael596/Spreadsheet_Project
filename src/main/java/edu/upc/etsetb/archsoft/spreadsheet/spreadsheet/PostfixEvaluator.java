...
/**
 * Class in charge of performing the evaluation of the formula introduced by the
 * user
 *
...
public class PostfixEvaluator {
     ...
     *
     * @param factory SpreadsheetFactory object that gets assigned to the
     * factory attribute
     */
     ...
     *
     * @param visitador SpreadsheetFactory object that gets assigned to the
     * factory attribute
     */
    ...
    /**
     * Function that evaluates the given token and uses the visitador to obtain
     * the computed value.
     *
